...
public class LvLedLightBulb extends LightBulb {
    ...
    public LvLedLightBulb(Item.Properties settings) {
        ...
        this.modelSupplier = () -> state -> PartialModel.of(modId(switch (state) {
            case OFF -> "block/lamps/lv_led_bulb";
            case LOW_POWER, ON -> "block/lamps/lv_led_bulb_on";
            case BROKEN -> "block/lamps/lv_led_bulb_broken";
            case LIGHT -> "block/lamps/lv_led_bulb_light";
        }));
        this.dyedModelSupplier = () -> state -> PartialModel.of(modId(switch (state) {
            case OFF -> "block/lamps/dyed_lv_led_bulb";
            case LOW_POWER, ON -> "block/lamps/dyed_lv_led_bulb_on";
            case BROKEN -> "block/lamps/dyed_lv_led_bulb_broken";
            case LIGHT -> "block/lamps/dyed_lv_led_bulb_light";
            case BULB -> "block/lamps/dyed_lv_led_bulb_bulb";
        }));
        applyRatedValues(
                RATED_POWER_WATTS,
                RATED_VOLTAGE_VOLTS,
